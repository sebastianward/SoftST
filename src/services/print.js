...
const ENTRY_ZPL_TEMPLATE = [
  ...
  "^LL400",
  "^LH0,0",
  "^FO80,72^A0N,28,28^FDRegistro Ingresos Antalis^FS",
  "^FO80,108^A0N,22,22^FDIngreso #@entry_id^FS",
  "^FO520,108^A0N,20,20^FD@created_at^FS",
  "^FO80,136^GB640,2,2^FS",
  "^FO80,150^A0N,18,18^FDRazon social:^FS",
  "^FO80,172^A0N,22,22^FD@business_name_1^FS",
  "^FO80,198^A0N,22,22^FD@business_name_2^FS",
  "^FO420,150^A0N,18,18^FDContacto:^FS",
  "^FO420,172^A0N,22,22^FD@contact_name_1^FS",
  "^FO420,198^A0N,22,22^FD@contact_name_2^FS",
  "^FO80,234^A0N,18,18^FDEquipo:^FS",
  "^FO80,256^A0N,22,22^FD@equipment_model_1^FS",
  "^FO80,282^A0N,22,22^FD@equipment_model_2^FS",
  "^FO420,234^A0N,18,18^FDSerie:^FS",
  "^FO420,256^A0N,22,22^FD@serial_number_1^FS",
  "^FO420,282^A0N,22,22^FD@serial_number_2^FS",
  "^FO80,318^A0N,18,18^FDIngresado por:^FS",
  "^FO80,340^A0N,22,22^FD@worker_name_snapshot_1^FS",
  "^FO80,366^A0N,22,22^FD@worker_name_snapshot_2^FS",
  "^XZ",
].join("\n");
...
function buildEntryZpl(entry) {
  const replacements = {
    ...
    ...buildWrappedFieldReplacements("business_name", entry.business_name, 22, 2),
    ...buildWrappedFieldReplacements("contact_name", entry.contact_name, 20, 2),
    ...buildWrappedFieldReplacements("equipment_model", entry.equipment_model, 22, 2),
    ...buildWrappedFieldReplacements("serial_number", entry.serial_number || "-", 18, 2),
